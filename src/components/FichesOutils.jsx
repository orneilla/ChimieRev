// Les briques communes aux deux vues des réactifs et des solvants :
// la liste (avec sa recherche) et la page individuelle de chacun.
...
export function Dessin({ cle, role = 'molecule', alt }) {
...
export function FicheReactif({ reactif, mode }) {
...
export function FicheSolvant({ solvant }) {
